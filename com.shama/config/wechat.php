...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxa847ca1a7adf0882'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'd23b6eddc526d8d971316de0ab79d79d'),     // AppSecret
     ...
     */
     'oauth' => [
         ...
         'callback' => env('WECHAT_OAUTH_CALLBACK', 'http://www.baidu.com'),
     ],
